...
- **State:** not_started
- **Current task:** T06 — Create /review-work skill body with scope resolver, artifact schema, and Pass 1/Pass 2 rubric
- **Last commit:** none
- **Preflight:** n/a
- **Blockers:** none
- **WIP files:** none
...
- [ ] T06 — Create `/review-work` skill body | files: `workflow-src/commands/review-work.md` (new), regenerated `monkeybars/skills/review-work/SKILL.md`, `monkeybars/commands/review-work.md`, Codex plugin copy | verify: `bun run test`, `bun run generate:check`
