...
state: in_progress
current_task: T08 — Document `/review-work` in README and AGENTS.md
last_commit: feat(T07): add review-scope helper and edge-case tests
...
| 2 | Add `/review-work` skill and artifact | in_progress |
